...
class GetAiMove {
  ...
  void _aiEntrypoint(Map<String, dynamic> message) async {
    ...
    final PieceColor aiPlayerColor = message['aiPlayerColor'] as PieceColor;
    ...
    final GameRepositoryImpl repository = GameRepositoryImpl();

    // استدعاء دالة الذكاء الاصطناعي من الـ repository
    final Move? aiMove = await repository.getAiMove(
      board,
      aiPlayerColor,
      aiDepth,
    );
