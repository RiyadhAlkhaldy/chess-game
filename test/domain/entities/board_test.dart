...
void main() {
  group('Board', () {
    ...
    test('  fenToBoard', () {
      ...
      print('FEN string used: $testFen');
      print(
        'Current Player: ${board.currentPlayer == PieceColor.white ? 'White' : 'Black'}',
      );
      print('Castling Rights: ${board.castlingRights}');
      ...
      print('FEN generated by the board: $currentBoardFen');
      print('Is this the initial FEN? ${currentBoardFen == initialFen}');
    });
  });
}
